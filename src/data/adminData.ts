...
export interface CarouselItem {
  ...
  hotWord: string;
  imageUrl: string;
  linkType: "series" | "episode" | "live-match" | "tv-channel" | "agent-plan";
  linkId: string;
  isActive: boolean;
  createdAt: string;
}
