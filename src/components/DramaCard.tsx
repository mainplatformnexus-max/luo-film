    ...
    <>
      ...
      >
        <div className="relative rounded-md overflow-hidden mb-1.5 aspect-[2/3]">
          ...
          />
          {isStillAgent && (
            <div className="absolute top-1.5 left-1.5 bg-accent text-accent-foreground text-[9px] font-bold px-1.5 py-0.5 rounded">
              🔥 Agent Only
            </div>
          )}
          {!isStillAgent && drama.badge && (
            <div className="absolute top-1.5 left-1.5 bg-badge-coming text-accent-foreground text-[9px] font-bold px-1.5 py-0.5 rounded">
              {drama.badge}
            </div>
          )}
          {drama.episodes && (
