  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <main className="flex-1 p-4 md:p-6 overflow-y-auto">
        ...
        {section === "carousel" && <CarouselSection carousels={carousels} series={series} episodes={episodes} tvChannels={tvChannels} search={search} />}
...
// ==================== CAROUSEL SECTION ====================
const CarouselSection = ({ carousels, series, episodes, tvChannels, search }: any) => {
